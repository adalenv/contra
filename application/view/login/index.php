...
<div class="wrapper">
  <div class="container">
    ...
    <h1 class="text"></h1>
    <form class="form" role='form' action='home/login' method='post'>
      	<input type="text" name="username" placeholder="Username" id='admin-username' required="required" class="input-txt" />
