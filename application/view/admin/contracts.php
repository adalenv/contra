            ...
            <script type="text/javascript">
                $('.contractsNav').addClass('active');
                    ...
                    $('#contract_type').val('<?=(isset($_GET['contract_type'])?$_GET['contract_type']:'%')?>');
                    $('#operator').val('<?=(isset($_GET['operator'])?$_GET['operator']:'%')?>');
                    $('#status').val('<?=(isset($_GET['status'])?$_GET['status']:'%')?>');
                    $('#cancellation_reason').val('<?=(isset($_GET['cancellation_reason'])?$_GET['cancellation_reason']:'%')?>');

                    $('#id').val('<?=(isset($_GET['id'])?$_GET['id']:'')?>');
                    $('#location').val('<?=(isset($_GET['location'])?$_GET['location']:'')?>');
                    $('#date').val('<?=(isset($_GET['date'])?$_GET['date']:'')?>');
                    $('#client_name').val('<?=(isset($_GET['client_name'])?$_GET['client_name']:'')?>');
