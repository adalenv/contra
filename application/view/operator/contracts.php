            ...
            <script type="text/javascript">
                    ...
                    $(function() {
                        ...
                        $('.pagination_btn').on('click',function(e) {
                            e.preventDefault();
                            if ($('#contract_type').val()!=contract_type || $('#operator').val()!=operator || $('#status').val()!=status || $('#codice_fiscale').val()!=codice_fiscale || $('#date').val()!=date || $('#client_name').val()!=client_name) {
                                $('.page_val').val(0);
                            }
                            document.forms[0].submit();
                        });
