                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                foreach ($users as $user) {
                                                  ...
                                                  $contractsNumberOkInserito1= (int)$this->model->getContractsNumberOkInserito($user->user_id,$date);
                                                  $workhours1= (float)$this->model->getWorkhours($user->user_id,$date);
                                                    ...
                                                    $output.='<td>'.$contractsNumberOkInserito1.'</td>';
                                                    $output.='<td>'.$workhours1.'</td>';
                                                    $output.='<td>'.(round(@($contractsNumberOkInserito1/$workhours1),3)).'</td>';
