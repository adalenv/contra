...
/////////////////////////////////////////////////////////////////////////////////////////
    ...
    public function getContractById($contract_id ){
        $sql='SELECT * FROM contracts INNER JOIN status ON contracts.status = status.status_id WHERE contract_id=:contract_id  AND contracts.operator=:user_id LIMIT 1 ';
        $query = $this->db->prepare($sql);
        $query->execute(array(':contract_id'=>$contract_id,'user_id'=>$_SESSION['user_id']));
        return $query->fetch();
    }
///////////////////////////////////////////////////////////////////
